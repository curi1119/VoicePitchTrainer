...
export const SCALE = {
  PATTERNS: {
    ...
    p3: [0, 4, 7, 4, 0],
    p4: [0, 4, 7, 12, 7, 4, 0],
    p5: [0, 4, 2, 5, 4, 7, 5, 2, 4, 0],
    p6: [0, 1, 2, 3, 4, 5, 4, 3, 2, 1, 0],
    p7: [0, 2, 4, 2, 0],
  } as Record<'p1' | 'p2' | 'p3' | 'p4' | 'p5' | 'p6' | 'p7', readonly number[]>,
  PATTERN_LABELS: {
    p1: '5音 C D E F G',
    p2: '1oct C D E F G A B C',
    p3: 'トライアド C E G',
    p4: 'アルペジオ C E G C',
    p5: '3度進行 C E D F…C',
    p6: '半音階 C C# D D# E F',
    p7: '3音 C D E D C',
  } as Record<'p1' | 'p2' | 'p3' | 'p4' | 'p5' | 'p6' | 'p7', string>,
  /** 1音ごとの判定セント幅(±) */
  TOLERANCE_CENTS: 60,
